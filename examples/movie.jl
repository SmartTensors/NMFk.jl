...
We, He, p, s = NMFk.execute(X, 3, 1; method=:ipopt, tolX=1e-15, tol=1e-14, seed=16, maxiter=9, movie=true, moviename="movie/m643-frame0001.png", Hinit=convert(Matrix{Float32}, H), Winit=convert(Matrix{Float32},W))
